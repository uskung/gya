...
axis.set_xlim([-xaxis_limit,xaxis_limit])
axis.set_ylim([-yaxis_limit,yaxis_limit])
...
def update_data(frame):
    ...
    animated_path.set_data(the1_list[:round(frame*animation_const):path_splice_limit], the2_list[:round(frame*animation_const):path_splice_limit])
...
#animation.save('parametric_animation.gif', writer='pillow', fps=40)
plt.show()