...
\begin{table}[h]
    ...
    \begin{tabular}{||c|c|c||}
        \hline
        $\theta_1$ [rad] & $\theta_2$ [rad] & 'Energinivå' \\
        \hline
        0.5 & 0.5 & Låg\\
        2.5 & 2.5 & Hög\\
        \hline
