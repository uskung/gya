...
\section{Tillämpning av Runge-kuttametoden i numerisk simulering}
För att utnyttja Runge-kuttametoden definierades en tillståndsvektor $\mathbf{X} = [\theta_1, \omega_1, \theta_2, \omega_2]$, vilket därmed ger att $\dot{\mathbf{X}} = [\omega_1, \dot{\omega}_1, \omega_2, \dot{\omega}_2]$. Ett program skrevs sedan i programmeringsspråket Python för att simulera en dubbelpendel genom Runge-kuttametoden. Dessutom skrevs kod som visar två pendlar samtidigt med nästan exakt samma startvillkor, men att vinklarna skiljer sig åt med en liten procentskillnad i storleksordningen $10^{-4}$. 
