...
För att däremot kunna använda (\ref{eq:equations_of_motion_numerical_section}) med Runge-Kuttametoden, måste de skrivas om till ordinära differentialekvationer på formen $x' = f(x,t)$. Vi börjar med att genomföra substitutionen $\dot{\theta}_1 = \omega_1$ och $\dot{\theta}_2 = \omega_2$, vilket ger:
\begin{equation}
    \begin{cases}
        \dot{\theta}_1 &= \omega_1  \\
        \dot{\theta}_2 &= \omega_2 \\
