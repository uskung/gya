...
\begin{figure}
    ...
    \begin{adjustwidth}{-2.5cm}{-2.5cm}
        ...
        \end{subfigure}
        \captionsetup{width=0.80\linewidth}
        \caption{Plot av vinklarna $\theta_1$ och $\theta_2$ som funktion av tiden. Alla plottar simulerades i 20s, förutom i figur \ref{subfig:angles_time_the1=2.5_the2=2.5}, där den simulerades i 30 s. }
    \end{adjustwidth}
\end{figure}