...
\begin{figure}[h!]
    \begin{adjustwidth}{-3cm}{-3cm}
        ...
        \end{subfigure}
        \captionsetup{width=0.9\linewidth}
        \caption{Plot av dubbelpendel med startvillkoren $\theta_1 = 0.7$ och $\theta_2 = 0.2$ [rad]. Simuleringen genomfördes i 180 s, men för figur \ref{subfig:plots_of_stable_pendulum_over_long_time_A} plottades 90 s för att göra kurvan mer läsbar. }
