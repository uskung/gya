...
\begin{figure}
    ...
    \begin{adjustwidth}{-2.5cm}{-2.5cm}
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            ...
            \label{subfig:angles_time_the1=2.5_the2=2.5}
        \end{subfigure} 
        ...
        \end{subfigure}
        \captionsetup{width=0.80\linewidth}
        \caption{Plot av vinklarna $\theta_1$ och $\theta_2$ som funktion av tiden. Alla dubbelpendlar simulerades i 20s, förutom i figur \ref{subfig:angles_time_the1=2.5_the2=2.5}, där den simulerades i 30 s. Simuleringen genomfördes med RK4-metoden.}
    \end{adjustwidth}
\end{figure}
...
\begin{figure}[ht]
    \begin{adjustwidth}{-2.5cm}{-2.5cm}
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            ...
            \caption{Färdväg för dubbelpendel. Startvillkor: $\theta_1 = 2.226$, $\theta_2 = 4.169$.}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            ...
            \caption{Parametrisk plot under 30 s av $\theta_1$ och $\theta_2$. Startvillkor: $\theta_1 = 2.226$, $\theta_2 = 4.169$.}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            ...
            \caption{Plot av vinklarna $\theta_1$ (blå) och $\theta_2$ (orange) som funktion av tiden. Startvillkor: $\theta_1 = 2.226$, $\theta_2 = 4.169$.}
        \end{subfigure}
        \captionsetup{width=0.80\linewidth}
        \caption{Simulering av pendlar med begynnelsevillkoren $\theta_1 = 2.899$ och $\theta_2 = 1.913$ (figur a, c och e), samt $\theta_1 = 2.226$ och $\theta_2 = -2.114$ (figur b, d och f) [rad]. Figur a och b visar den streckade linjen den färdväg som pendeln tagit. Figur c och d visar en parametrisk plot för pendlarna. Figur e och f visar vinklarna $\theta_1$ och $\theta_2$ som funktion av tiden. Alla simuleringar genomfördes med RK4-metoden.}
    \end{adjustwidth}
\end{figure}
...
\begin{figure}[ht]
    \begin{adjustwidth}{-2.5cm}{-2.5cm}
        ...
        \end{subfigure}
        \caption{Plot av dubbelpendel med startvillkoren $\theta_1 = 2.9$ och $\theta:2 = -3.1$ [rad]. Simuleringen pågick under 180 s, och genomfördes med RK4-metoden med en steglängd på 0.00005 s.}
    \end{adjustwidth}    
\end{figure}
